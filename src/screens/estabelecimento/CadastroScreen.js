...
const CadastroScreen = (props) => {
    ...
    validationShape = {
      ...
      cpf_cnpj: Yup.string()
        ...
        .test("cpf-valido", "Informe um CPF ou CNPJ válido", (val) => {
          if (cpfInputRef) return cpfInputRef.isValid();
  ...
  return (
    <Container>
      <Page
        title={
          editMode ? "Editar dados pessoais" : "Cadastre seu Estabelecimento"
        }
        headerBackButton={
          <HeaderButton
            iconName="arrow-left"
              ...
              {({
                ...
                <Fragment>
                  <View>
                    ...
                    <TextInputMask
                      ...
                      style={
                        touched.cpf_cnpj && errors.cpf_cnpj
                          ? { ...styles.inputCpfCnpj, borderBottomColor: "red" }
                          : {
                              ...styles.inputCpfCnpj,
                    ...
                    <ErrorMessage
                      errorValue={touched.cpf_cnpj && errors.cpf_cnpj}
                    />
                  </View>
                  <View>
                    <Label>Nome</Label>
                  ...
                  <View>
                    ...
                    <ErrorMessage
                      errorValue={touched.telefone && errors.telefone}
                    />
                  </View>
                  {!editMode && (
                    <>
